...
/*
import net.offllneplayer.opvanillaplus.method.Proc_ApplyCryingIIProcedure;
*/
...
public class CryingAxeItem extends AxeItem {
	...
	public CryingAxeItem() {
		super(TOOL_TIER, new Properties().attributes(DiggerItem.createAttributes(TOOL_TIER, 9.5f, -2.9f)).fireResistant());
	}
