...
public record IronFurnaceButtonHandler(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<IronFurnaceButtonHandler> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OPVanillaPlus.Mod_ID, "gui_iron_furnace_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OPVanillaPlus.addNetworkMessage(IronFurnaceButtonHandler.TYPE, IronFurnaceButtonHandler.STREAM_CODEC, IronFurnaceButtonHandler::handleData);
	}
}