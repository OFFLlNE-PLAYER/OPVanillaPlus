...
public record DiamondFurnaceButtonHandler(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<DiamondFurnaceButtonHandler> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OPVanillaPlus.Mod_ID, "gui_diamond_furnace_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OPVanillaPlus.addNetworkMessage(DiamondFurnaceButtonHandler.TYPE, DiamondFurnaceButtonHandler.STREAM_CODEC, DiamondFurnaceButtonHandler::handleData);
	}
}