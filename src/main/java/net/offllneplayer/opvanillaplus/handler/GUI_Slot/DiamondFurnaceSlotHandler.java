...
public record DiamondFurnaceSlotHandler(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<DiamondFurnaceSlotHandler> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OPVanillaPlus.Mod_ID, "gui_diamond_furnace_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OPVanillaPlus.addNetworkMessage(DiamondFurnaceSlotHandler.TYPE, DiamondFurnaceSlotHandler.STREAM_CODEC, DiamondFurnaceSlotHandler::handleData);
	}
}
