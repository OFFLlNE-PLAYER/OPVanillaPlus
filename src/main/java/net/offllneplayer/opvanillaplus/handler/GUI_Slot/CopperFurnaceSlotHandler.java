...
public record CopperFurnaceSlotHandler(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<CopperFurnaceSlotHandler> TYPE = new Type<>(ResourceLocation.fromNamespaceAndPath(OPVanillaPlus.Mod_ID, "gui_copper_furnace_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		OPVanillaPlus.addNetworkMessage(CopperFurnaceSlotHandler.TYPE, CopperFurnaceSlotHandler.STREAM_CODEC, CopperFurnaceSlotHandler::handleData);
	}
}
