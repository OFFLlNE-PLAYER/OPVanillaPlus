...
import net.offllneplayer.opvanillaplus.handler.GUI_Button.*;

import java.util.HashMap;

import com.mojang.blaze3d.systems.RenderSystem;

public class CopperFurnaceGUI extends AbstractContainerScreen<CopperFurnaceInv> {
	private final static HashMap<String, Object> guistate = CopperFurnaceInv.guistate;
	...
	public CopperFurnaceGUI(CopperFurnaceInv container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("opvanillaplus:textures/screens/gui_copper_furnace.png");
	...
	public void init() {
		...
		imagebutton_text_experience_bottle_button = new ImageButton(this.leftPos + 115, this.topPos + 59, 16, 16,
			...
			if (true) {
				PacketDistributor.sendToServer(new CopperFurnaceButtonHandler(0, x, y, z));
				CopperFurnaceButtonHandler.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_text_stoke_button = new ImageButton(this.leftPos + 39, this.topPos + 58, 16, 16,
			...
			if (true) {
				PacketDistributor.sendToServer(new CopperFurnaceButtonHandler(1, x, y, z));
				CopperFurnaceButtonHandler.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
