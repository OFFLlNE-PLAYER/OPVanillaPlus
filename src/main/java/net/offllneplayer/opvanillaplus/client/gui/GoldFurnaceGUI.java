...
import net.offllneplayer.opvanillaplus.handler.GUI_Button.GoldFurnaceButtonHandler;
...
public class GoldFurnaceGUI extends AbstractContainerScreen<GoldFurnaceInv> {
	private final static HashMap<String, Object> guistate = GoldFurnaceInv.guistate;
	...
	public GoldFurnaceGUI(GoldFurnaceInv container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("opvanillaplus:textures/screens/gui_gold_furnace.png");
	...
	public void init() {
		...
		imagebutton_text_experience_bottle_button = new ImageButton(this.leftPos + 115, this.topPos + 59, 16, 16,
			...
			if (true) {
				PacketDistributor.sendToServer(new GoldFurnaceButtonHandler(0, x, y, z));
				GoldFurnaceButtonHandler.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_text_stoke_button = new ImageButton(this.leftPos + 39, this.topPos + 58, 16, 16,
			...
			if (true) {
				PacketDistributor.sendToServer(new GoldFurnaceButtonHandler(1, x, y, z));
				GoldFurnaceButtonHandler.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
