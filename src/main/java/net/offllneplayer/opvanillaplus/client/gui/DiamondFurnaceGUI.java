...
import net.offllneplayer.opvanillaplus.handler.GUI_Button.DiamondFurnaceButtonHandler;
import net.offllneplayer.opvanillaplus.method.furnaces.*;
import net.offllneplayer.opvanillaplus.world.inventory.DiamondFurnaceInv;

import java.util.HashMap;

import com.mojang.blaze3d.systems.RenderSystem;

public class DiamondFurnaceGUI extends AbstractContainerScreen<DiamondFurnaceInv> {
	private final static HashMap<String, Object> guistate = DiamondFurnaceInv.guistate;
	...
	public DiamondFurnaceGUI(DiamondFurnaceInv container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("opvanillaplus:textures/screens/gui_diamond_furnace.png");
	...
	public void init() {
		...
		imagebutton_text_experience_bottle_button = new ImageButton(this.leftPos + 115, this.topPos + 59, 16, 16,
			...
			if (true) {
				PacketDistributor.sendToServer(new DiamondFurnaceButtonHandler(0, x, y, z));
				DiamondFurnaceButtonHandler.handleButtonAction(entity, 0, x, y, z);
			}
		}) {
			@Override
		...
		imagebutton_text_stoke_button = new ImageButton(this.leftPos + 39, this.topPos + 58, 16, 16,
			...
			if (true) {
				PacketDistributor.sendToServer(new DiamondFurnaceButtonHandler(1, x, y, z));
				DiamondFurnaceButtonHandler.handleButtonAction(entity, 1, x, y, z);
			}
		}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int x, int y, float partialTicks) {
